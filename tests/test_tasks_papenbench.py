"""This script should be launched using at least 8 CPUs, i.e.
pytest -n 8 test_tasks_papenbench.py.

Note: Tasks of the form 5fullRegion* require massive memory. Take caution.
"""
...
def filenames():
    ...
    _filenames = list(Path("carps/configs/task").glob("PapenBench/*.yaml"))
    _filenames.sort()
    return _filenames
