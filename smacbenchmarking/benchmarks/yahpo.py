...
class YahpoProblem(Problem):
    ...
    def __init__(self, bench: str, instance: str, budget_type: str, metric: str, lower_is_better:
    bool = True) -> None:
        ...
        assert str(instance) in self.COMBIS[
            bench], f"The instance you choose is not available in " f"{bench}."
        ...
        assert budget_type in self.fidelity_dims, (
            f"The budget type you choose is not available "
    ...
    def evaluate(self, trial_info: TrialInfo) -> float:
        ...
        xs = dict(configuration)  # .get_dictionary()
