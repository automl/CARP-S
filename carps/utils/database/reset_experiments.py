...
def main(pyexperimenter_configuration_file_path: str | None = None, database_credential_file_path: str | None = None) -> None:
    experiment_configuration_file_path = pyexperimenter_configuration_file_path or Path(__file__).parent.parent.parent / "container/py_experimenter.yaml"

    database_credential_file_path = database_credential_file_path or Path(__file__).parent.parent.parent / "container/credentials.yaml"
