...
bash scripts/build_env.sh HPOB SMAC3 3.11 $ENV_LOCATION
...
bash scripts/build_env.sh HPOBench SMAC3 3.10 $ENV_LOCATION
bash scripts/build_env.sh HPOBench SMAC3-1.4 3.10 $ENV_LOCATION
bash scripts/build_env.sh HPOBench RandomSearch 3.10 $ENV_LOCATION
bash scripts/build_env.sh HPOBench HEBO 3.10 $ENV_LOCATION
bash scripts/build_env.sh HPOBench SyneTune 3.10 $ENV_LOCATION
...
# do
#     for optimizer in "SMAC3" "SMAC3-1.4" "RandomSearch" "HEBO" "SyneTune"
#     do
