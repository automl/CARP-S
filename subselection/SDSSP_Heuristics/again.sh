...
command_function() {
    ...
    SHIFT_TRIES=${SHIFT_TRIES:-20} ${executable} subset_complement_${value}.txt ${dimension} $(expr ${num_points} - ${value}) ${value} subset_complement_subset_${value}.txt 2>&1 > log_subset_complement_${value}.txt
