...
## Local Development
To promote compatibility, we encourage to enable `numpy>2.0.0` and `ConfigSpace>1.0.0`, and, in general, supporting
...
3. The pull request should work for `Python 3.12` (ideally newer versions) and
